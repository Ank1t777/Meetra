...
const LoginPage = () => {
  ...
  return (
    <div className='h-screen flex itmes-center justify-center p-4 sm:p-6 md:p-8' data-theme={theme}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm opacity-70">
                Sign in to your account or continue your language learning journey.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="text-center mt-4">
                <p className="text-sm">
                  ...
                  <Link to='/signup' className="text-primry hover:underline">
                    Create one
                  </Link>
                </p>
              </div>
